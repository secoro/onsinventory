# Pantry Pilot Frontend

Modern React frontend for the Inventory & Recipe Recommendation backend.
...
```bash
cd /Users/seanderoo/Repositories/Local/AI-Assisted-Development/inventory-frontend
cp .env.example .env
npm install
npm run dev
```
