            ...
            <div className="flex flex-col items-end gap-3">
              <div ref={accountMenuRef} className="relative">
                ...
                >
                  ...
                  Account
                  <ChevronDown className={`h-3.5 w-3.5 transition-transform ${showAccountMenu ? "rotate-180" : ""}`} />
                </button>
                {showAccountMenu && (
                  <div className="absolute right-0 z-40 mt-2 w-56 overflow-hidden rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 shadow-lg">
                    <button
                      type="button"
                      onClick={() => { setDark((d) => !d); setShowAccountMenu(false); }}
                      className="flex w-full items-center gap-2 px-4 py-2.5 text-left text-sm text-slate-700 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-slate-800"
                    >
                    ...
                    <button
                      type="button"
                      onClick={() => { setShowInviteHousehold(true); setShowAccountMenu(false); }}
                      className="flex w-full items-center gap-2 px-4 py-2.5 text-left text-sm text-slate-700 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-slate-800"
                    >
                    ...
                    <button
                      type="button"
                      onClick={() => { setShowDeleteAccount(true); setShowAccountMenu(false); }}
